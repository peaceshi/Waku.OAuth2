...
/// Gitee's OAuth.
/// </para>
/// <see href="https://gitee.com/api/v5/oauth_doc#/" />.
/// </summary>
public class Gitee : RequestProvider
{
    private readonly UriBuilder _authorizeBaseURL = new("https://gitee.com/oauth/authorize");
    ...
    /// <see href="https://docs.github.com/en/developers/apps/building-oauth-apps/authorizing-oauth-apps#parameters" />.
    /// </summary>
    required public override string? Redirect_URI { get; init; }
